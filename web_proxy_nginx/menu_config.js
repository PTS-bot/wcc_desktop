const appConfig = {
    title: "",
    menus: [
        { id: "webtop1", name: "Webtop1", icon: "fas fa-robot", url: "/webtop1/", active: false },
        { id: "webtop2", name: "Webtop2", icon: "fas fa-robot", url: "/webtop2/", active: false },
        { id: "webtop3", name: "Webtop3", icon: "fas fa-robot", url: "/webtop3/", active: false },
        { id: "webtop4", name: "Webtop4", icon: "fas fa-robot", url: "/webtop4/", active: false },
        { id: "webtop5", name: "Webtop5", icon: "fas fa-robot", url: "/webtop5/", active: false },
        { id: "webtop6", name: "Webtop6", icon: "fas fa-robot", url: "/webtop6/", active: false },
        { id: "webtop7", name: "Webtop7", icon: "fas fa-robot", url: "/webtop7/", active: false },
        { id: "webtop8", name: "Webtop8", icon: "fas fa-robot", url: "/webtop8/", active: false },
        { id: "webtop9", name: "Webtop9", icon: "fas fa-robot", url: "/webtop9/", active: false },
